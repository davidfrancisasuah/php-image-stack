...
<body>
    ...
    <header class="bg-white shadow-sm sticky-top py-4 px-5 border-bottom">
        <h1 class="text-center text-primary fw-bold">Simple Image Stack</h1>
        <p class="text-center text-muted fs-5 mb-0">
            Discover a Collection of Free Image Stacks. All media on this site is sourced through the <strong>pexels.com</strong> API.
        </p>
        <p class="text-center text-muted">Uncover a world of captivating visuals at your fingertips!</p>
        <div class="d-flex justify-content-center mt-4">
            <input type="search" id="search" placeholder="Enter Keywords Here" class="form-control form-control-lg rounded-pill w-50 shadow-sm" aria-label="Search input" value="<?= $search ?>">
        </div>
    </header>
